...
UUID=${UUID:-'28a31425-370d-4316-b8c2-2dd03e554901'}
VMESS_WSPATH=${VMESS_WSPATH:-'/vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vless'}
URL=${USER}.alwaysdata.net

wget -q -O $TMP_DIRECTORY/config.json https://raw.githubusercontent.com/KfsrwDft9898/rlamaieke-appnwt2/main/config.json
